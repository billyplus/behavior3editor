...
var preload_js = ['src/assets/js/preload.js'];
...
var app_less = ['src/assets/less/index.less'];
var app_imgs = ['src/assets/imgs/**/*'];
var app_html = ['src/app/**/*.html'];
var app_entry = ['src/index.html', 'src/package.json', 'src/desktop.js'];
...
gulp.task('_vendor_fonts', function () {
    return gulp.src(vendor_fonts).pipe(gulp.dest('build/fonts'));
});
...
gulp.task('_app_imgs', function () {
    return gulp.src(app_imgs).pipe(gulp.dest('build/imgs'));
});
...
gulp.task('_electron_zip', ['_electron'], function () {
    return gulp.src('.temp-dist/*').pipe(
